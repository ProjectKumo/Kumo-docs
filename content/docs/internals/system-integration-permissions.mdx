---
title: System integration and permissions
description: App bundle metadata, entitlements, system proxy commands, Spotlight, Services, App Intents, the CLI symlink, and the permission boundaries Kumo lives within.
---
