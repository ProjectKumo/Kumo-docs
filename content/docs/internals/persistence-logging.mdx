---
title: Persistence and logging
description: Where Kumo keeps state on disk — Application Support layout, state files, preferences, backups, the update cache, and every log channel.
---
...
[Release Management](/docs/internals/release-management).
