---
title: Proxies page scroll container
description: Why the Proxies card list owns a single full-page ScrollView, and the regression checklist that keeps that layout intact.
---
...
- The page must follow [Page Titles and Window Chrome](/docs/internals/page-title-chrome).
