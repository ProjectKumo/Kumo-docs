---
title: Mihomo runtime and controller
description: How Kumo supervises the Mihomo process, the controller API surface it consumes, transport details, and error handling.
---
