---
title: CLI and agent control
description: How the kumo executable is designed, installed, and used — including JSON envelopes, logging, agent skills, and service-mode delegation.
---
