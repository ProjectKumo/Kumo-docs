---
title: Page titles and window chrome
description: Where Kumo destination titles live, why pages do not repeat them inline, and the checklist that catches regressions.
---
