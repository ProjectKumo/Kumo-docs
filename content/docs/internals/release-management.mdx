...
description: Release channels, the latest.yml manifest, DMG packaging, and the make targets that build a signed Kumo.app for distribution.
---
...
documented in [App Updates](/docs/internals/app-updates).
...
compatibility. See [App Updates](/docs/internals/app-updates) for the runtime
...
For runtime behavior, see [App Updates](/docs/internals/app-updates). That document
