---
title: Service mode
description: Why Kumo's privileged service exists, the proposed API surface, request signing, the migration plan, and the status of locally hosted subsystems.
---
